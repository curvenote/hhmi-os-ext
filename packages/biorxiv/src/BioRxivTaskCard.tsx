...
import { BioRxivTrackEvent } from './analytics/events.js';

const BIORXIV_SUBMISSION_URL = 'https://www.biorxiv.org/submit-a-manuscript';
const BIORXIV_LOGO_URL =
  'https://www.biorxiv.org/sites/default/files/bioRxiv_logo_homepage7-5-18.svg';
...
export function BioRxivTaskCard() {
  ...
  return (
    <a
      ...
      className="block h-full no-underline text-foreground"
    >
      <primitives.Card
        lift
        className="relative p-0 h-full bg-white transition-colors border-stone-400"
      >
        <div className="px-2 py-4 w-full h-full cursor-pointer hover:bg-accent/50">
          <div className="flex gap-4 items-center mx-2 h-full">
            <div className="flex-shrink-0">
              <img src={BIORXIV_LOGO_URL} alt="bioRxiv" className="object-contain w-20 h-20" />
            </div>
